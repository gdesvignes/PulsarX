...
namespace Pulsar
{
	...
	public:
		PulsarPlot();
		~PulsarPlot();
	  void plot(const ArchiveLite &archive, GridSearch &gridsearch, std::map<std::string, std::string> &obsinfo, int id, const string &rootname, const int fscrunch, bool plotx=false);        
	public:
